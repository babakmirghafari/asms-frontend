...
export const PermissionsStore = signalStore(
  ...
  withMethods((store) => ({
    // TODO(angular-logic-implementer): inject generated PermissionsService and implement real API calls
    async load(): Promise<void> {
      patchState(store, { loading: true, error: null });
      // TODO(angular-logic-implementer): call service.listPermissionss() and patchState with response
