...
export const AccessControlStore = signalStore(
  withState(initialAccessControlState),
  withComputed((store) => ({
    selected: computed(() =>
  ...
  withMethods((store) => ({
    // TODO(angular-logic-implementer): inject generated AccessControlService and implement real API calls
    async load(): Promise<void> {
      patchState(store, { loading: true, error: null });
      // TODO(angular-logic-implementer): call service.listAccessControls() and patchState with response
